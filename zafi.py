...
"""%s
 ...
 - author      : Romi Afrizal
 - facebook    : facebook.com/AhmedAlzwage
 - fanspage    : facebook.com/♡♕
 - whatsap     : +218921762445
 - github      : github.com/HackerLibya
 - script name : (Facebook Libya)
 - version     : 1.1
...
def banner():
	print (''' %s 
 © Group%s \n __________       _____.__  \n \____    /____ _/ ____\__| %s> %sXNX \n   /     /\\__  \\\   __\|  | %s> %sO_O \n  /     /_ / __ \|  |  |  | %s>%s Facebook [Meta] \n /_______ (____  /__|  |__| %s>%s Libya \n         \/    \/ \n %s[%s*%s] By : %sAhmed Alzwage \n %s[%s*%s] -------------------------------------- \n [%s*%s] IP : %s%s'''%
